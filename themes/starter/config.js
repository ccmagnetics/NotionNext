...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/cc_logo.svg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/logo/cc_logo_w.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg

  // MENU ， 菜单部分不在此处配置，请在Notion数据库中添加MENU

  // 英雄区块导航
  STARTER_HERO_ENABLE: true, // 开启英雄区
  STARTER_HERO_TITLE_1: 'Eliminate the $2,000 Per-Ring Tooling Cost.', // 英雄区文字
  STARTER_HERO_TITLE_2: 'Stop waiting on prototyping costs. We provide direct access to 1,000+ production-ready magnetic ring molds, saving your R&D budget over $2,000 per iteration. Your breakthrough starts now.', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: 'Access Mold Library', // 英雄区按钮
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/cc_hero1.webp', // 产品预览图 ，默认读取public目录下图片
  STARTER_HERO_BANNER_IMAGE: '', // hero区下方的全宽图

  // 顶部右侧导航暗流
  STARTER_NAV_BUTTON_1_TEXT: 'Youtube',
  STARTER_NAV_BUTTON_1_URL: 'https://www.youtube.com/@ccmagnetics',

  STARTER_NAV_BUTTON_2_TEXT: 'Linkedin',
  STARTER_NAV_BUTTON_2_URL: 'https://www.linkedin.com/company/ccmagnetics/',
  ...
  STARTER_404_TEXT: 'Sorry! The page you were looking for does not exist. It may have been moved or deleted.',
  ...
  STARTER_CTA_DESCRIPTION:
    'Access the NotionNext operating documentation, we provide detailed tutorials to help you set up your site instantly.',
  ...
  STARTER_POST_REDIRECT_URL: 'https://www.magnetics.cc', // 重定向域名
